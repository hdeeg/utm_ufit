...
;
; CALLING SEQUENCE:
;   ufit_exofast_errell, xpar, ypar [,NXBIN=nxbin,NYBIN=nybin,PROBS=PROBS]$
...
;   2019/02/28 - H. Deeg: adapted to UTM/UFIT: removed unneeded keyword 
;                outsidendx to avoid dependency on Coyote's inside.pro
;-
pro ufit_exofast_errell, xpar, ypar, probs=probs, xpath=xpath, ypath=ypath, $
                    plot=plot, oplot=oplot, $
                    nxbin=nxbin, xmin=xmin, xmax=xmax, $
                    nybin=nybin, ymin=ymin, ymax=ymax;, outsidendx = outsidendx
...
for i=0, n_elements(info)-1 do begin
    ...
    ;; (isinside = 0)
;below code that is commented out for ufit version of this routine
