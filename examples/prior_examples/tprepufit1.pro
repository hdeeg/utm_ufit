pro tprepufit1
;test preporc  with built-in priors
;pro wd_fitR_lomass
...
;BELOW CODE FOR PRIORS


;gaussian prior for star radius 0.0108+-0.002
r1pri=0.0108D   
r1sig=0.0002D       
chisqadd=((r1-r1pri)/r1sig)^2  ;chisq from prior
paradd,'chisqadd',chisqadd


;uninformed prior to keep a linear limbdarkening in limits 0.165 to 0.465
ld=double(parasign("0limbd"))   ;get current LD value
if ld lt 0.165 or ld gt 0.465 then paradd,'oobflag',1   

;An alternative would be to use:
;if ld lt 0.165 or ld gt 0.465 then chisqadd=!VALUES.F_INFINITY 
;paradd,'chisqadd',chisqadd    ;write chisqadd to setup 
;the setting of oobflag=1 is however preferred, as it will avoid an
;unnecessary invocation of the modeller program
